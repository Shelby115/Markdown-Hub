...
public class AuthenticationProvidersControllerTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly AuthenticationProvidersController _sut;
    private readonly AppUser _admin;

    public AuthenticationProvidersControllerTests()
    {
        ...
        _sut = new AuthenticationProvidersController(_db, currentUser, audit, safety, secretProtector);
    }
